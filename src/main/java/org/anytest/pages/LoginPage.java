...
public class LoginPage {
    ...
    public LoginPage clickLoginLink()
    {
        ...
        Framework_Logger.log(LogType.PASS_EXTENT_AND_LOG,"Login Link is clicked");
        return this;
    }
    public LoginPage setUsername(String username)
    {
        DriverManager.getDriver().findElement(email).sendKeys(username);
        Framework_Logger.log(LogType.PASS_EXTENT_AND_LOG,"Username : "+ConfigFactory.getConfig().username()+" is entered.");
        return this;
    }
    public LoginPage setPassword(String pswd)
    {
        DriverManager.getDriver().findElement(password).sendKeys(pswd);
        Framework_Logger.log(LogType.PASS_EXTENT_AND_LOG,"Password: "+ConfigFactory.getConfig().password()+" is entered");
        return this;
    }
    public void clickLoginButton()
    {
        DriverManager.getDriver().findElement(login_button).click();
        Framework_Logger.log(LogType.PASS_EXTENT_AND_LOG,"Login Button is clicked");
    }
}
